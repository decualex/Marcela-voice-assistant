...
def assistme():
    speak("""I will kindly walk you through all there is to know about me. 
    On your screen there are 4 buttons.
    ...
    And last but not least, the 'EXIT' button which you press when you need to exit.""")
...
def main_screen():
    ...
    assist_button = Button(text='Assist me!', command=assistme, bg='red')
